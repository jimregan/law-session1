...
\begin{frame}
  ...
  \begin{description}
    \item[Extensible] \hfill \\
    Capable of being extended\footnote{Wiktionary}
    \item[Markup Language] \hfill \\
    a system for annotating a text in a way which is syntactically 
    distinguishable from that text\footnote{Wikipedia}
  \end{description}
